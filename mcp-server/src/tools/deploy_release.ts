/**
 * deploy_release orchestrates end-to-end release flows: deploySafe shells to sf deploy locally,
 * releaseBranch fans apex/agent tests after deploy, and releaseWithPlanning stitches planning, discovery,
 * scaffolding, doc-sync, deploy, and test checkpoints. Org IO happens only through the sf CLI adapter.

/**
 * utterance.ts manages virtual UAT packs: utteranceSeed emits YAML locally from plan data, utteranceRun
 * executes that pack via orgAgentTest, and utteranceAnalyze reconciles the stored results—tying together
 * local YAML and sf CLI outputs in .artifacts/utterance.
